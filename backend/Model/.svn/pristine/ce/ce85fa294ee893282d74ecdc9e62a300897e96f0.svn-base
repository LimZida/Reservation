 ...
 * 시간 대 존재하는 회의
 */
public class RES1200S1Response_Body_reserveList {
	/**
	 * 예약 시작 시간
	 */
	...
	public RES1200S1Response_Body_reserveList() {
	}

	public RES1200S1Response_Body_reserveList(JsonNode jsonNode) {
	...
	public String toString() {
		...
		builder.append("RES1200S1Response_Body_reserveList [");
