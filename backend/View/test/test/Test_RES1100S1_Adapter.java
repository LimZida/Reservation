...
public class Test_RES1100S1_Adapter extends TestAdapter {

	@Autowired
	private RES1100S1_Adapter adapter;
	private JsonAdaptorObject obj = new JsonAdaptorObject();

	@Before
	public void setUp() throws Exception {
		//TODO 요청데이터 입력. JsonAdaptorObject.TYPE.REQUEST
		InputStream in = new FileInputStream(new File("./test/data/RES1100S1.json"));
